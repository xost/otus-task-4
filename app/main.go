...
func main() {
	...
	r.HandleFunc("/api/users", createUserHandle).Methods("POST")
	r.HandleFunc("/api/users", getUserHandle).Methods("GET")
	r.HandleFunc("/api/users/{id}", getUserHandle).Methods("GET")
	r.HandleFunc("/api/users/{id}", updateUserHandle).Methods("PUT")
	r.HandleFunc("/api/users/{id}", deleteUserHandle).Methods("DELETE")
